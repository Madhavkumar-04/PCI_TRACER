...
const Login = () => {
  ...
  return (
    <div className="auth-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height:"auto", backgroundColor:'#1e1e1e', margin:'2rem'}}>
      <div className="auth-form" style={{ backgroundColor: '#1e1e1e', color: '#e0e0e0', padding: '2rem', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', maxWidth: '400px', margin: 'auto' }}>
        ...
        <a href="http://localhost:5000/auth/google" style={{ color: '#e0e0e0', display: 'block', textAlign: 'center', marginTop: '1rem' }}>Login with Google</a>
